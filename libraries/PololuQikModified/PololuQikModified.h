...
class PololuQik
{
  public:
	...
	PololuQik(Serial thisSerial, unsigned char resetPin);
...
class PololuQik2s9v1 : public PololuQik
{
  public:
	...
	PololuQik2s9v1(Serial thisSerial, unsigned char resetPin) : PololuQik(thisSerial, resetPin);
...
class PololuQik2s12v10 : public PololuQik
{
  public:
	...
	PololuQik2s12v10(Serial thisSerial, unsigned char resetPin) : PololuQik(thisSerial, resetPin);
